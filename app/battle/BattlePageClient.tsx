      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="arcade-card p-6">
            ...
            <div className="bg-black/30 p-4 rounded mb-6 min-h-40 flex flex-col items-center justify-center">
              <div className="text-center">
                <p className="text-white mb-4">No warriors selected</p>
                <p className="text-gray-400 text-sm mb-6">
                  Select warriors from the list above to add them to your team.
                </p>

                <div className="flex gap-4 justify-center">
                  <WarriorSelectionModal availableWarriors={availableWarriors} />
                  <button className="arcade-btn text-white text-sm px-4 py-2 bg-pink-700 hover:bg-pink-600 transition-colors">
                    CREATE WARRIOR
                  </button>
                </div>
              </div>
...
// Warrior Selection Modal Component
function WarriorSelectionModal({ availableWarriors }) {
  ...
  return (
    <>
      <button
        ...
        className="arcade-btn text-white text-sm px-4 py-2 bg-purple-700 hover:bg-purple-600 transition-colors"
      >
        SELECT WARRIOR
      </button>

      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="bg-gray-900 border border-pink-500 max-w-4xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="font-pixel text-2xl text-center text-pink-400">SELECT YOUR WARRIOR</DialogTitle>
          </DialogHeader>
