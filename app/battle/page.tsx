  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-pixel mb-4 neon-text">BATTLE ARENA</h1>
        <p className="text-lg max-w-3xl mx-auto">
          Choose your warriors, select your battle mode, and fight for glory in the MemeWars arena!
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="arcade-card p-6 text-center hover:scale-105 transition-transform duration-300 cursor-pointer">
          <h3 className="font-pixel text-2xl mb-4 text-pink-400">3v3 TEAM BATTLE</h3>
          <div className="bg-gradient-to-b from-purple-900/50 to-pink-900/50 p-4 rounded-lg mb-4">
            <Image
              src="/images/battle/3v3.png"
              alt="3v3 Team Battle"
              width={200}
              height={200}
              className="object-contain mx-auto"
          ...
          <p className="text-white mb-4">Assemble a team of three warriors to battle against another player's team!</p>
          <div className="bg-black/30 p-2 rounded mb-4">
            <span className="text-pink-300">REWARDS</span>
        ...
        <div className="arcade-card p-6 text-center hover:scale-105 transition-transform duration-300 cursor-pointer">
          ...
          <div className="bg-gradient-to-b from-purple-900/50 to-pink-900/50 p-4 rounded-lg mb-4">
            <Image
              src="/images/battle/tournament.png"
              alt="Tournament"
              width={200}
              height={200}
              className="object-contain mx-auto"
